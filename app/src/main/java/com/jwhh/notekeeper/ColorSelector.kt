...
constructor(context: Context, attributeSet: AttributeSet? = null,
  ...
  private var listOfColors = listOf( Color.BLUE, Color.BLACK, Color.RED)
    private var selectedColorIndex = 0
        ...
        init {
            ...
            colorEnabled.setOnCheckedChangeListener{
                buttonView, isChecked ->
                broadcastColor()
            }

        }
    var selectColorValue: Int = android.R.color.transparent
    set(value){
